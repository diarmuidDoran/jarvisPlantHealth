...
async def health_check_asyc():
    ...
    for plant in plants:
        ...
        plant_plant_health_attribute_response = requests.get(f'http://127.0.0.1:5000/documented_api/plants/{(plant["id"])}/plant_health_attributes')
        ...
        plant_health_attributes = plant_plant_health_attribute["plant_health_attributes"]
        for plant_health_attribute in plant_health_attributes:
            ...
            if health_attribute_id == 1:
                ...
                water.water_required_check(sensor_conn_pin, plant_id, sensor_id, plant_health_attribute_id)
            ...
            if (health_attribute_id == 3)  or (health_attribute_id == 4):
                ...
                if health_attribute_id == 3:
                    ...
                    requests.post(f'http://127.0.0.1:5000/documented_api/sensors/{sensor_id}/readings', json = {
                    ...
                    if(sensor_reading<lower_limit or sensor_reading>upper_limit):
                        ...
                        + "Air temp. levels set as optimal are between " + str(upper_limit) +" - " + str(lower_limit) + ".\n" 
                        + "Recorded air temperature: " +str(temperature_c)
                        requests.post(f'http://127.0.0.1:5000/documented_api/notifications', json={
                ...
                if health_attribute_id == 4:
                    ...
                    if(sensor_reading<lower_limit or sensor_reading>upper_limit):
                        ...
                        + "Air humidity levels set as optimal are between " + str(upper_limit) +" - " + streams(lower_limit) + "." 
            ...
            if health_attribute_id == 5:
                ...
                sensor_reading = int(lux) #input which ever light reading you wish, sensor could be set up to record all these light frequencys seperatly
                time = datetime.datetime.now()
                formated_datetime = time
                ...
                if(sensor_reading<lower_limit or sensor_reading>upper_limit):
                        ...
                        + "Light levels set as optimal are between " + str(upper_limit) +" - " + str(lower_limit) + ".\n" 
