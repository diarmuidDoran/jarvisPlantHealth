...
# Reading from CH0-7 plant soil moister sensors linked to the MCP3008
...
def checkTankMoistureSensor():
    outputTanklSensor = analogInput(
        1
    )  # change the number 1 if you set up your tank on any of the MCP3008 that are not CH1.
    # If you use pin 0 for your tank input 0 in the analogInput like so analogInput(0).
