...
def loads(s: str, *, parse_float: ParseFloat = float) -> Dict[str, Any]:  # noqa: C901
    ...
    while True:
        ...
        #    - comment
        #    - key/value pair
        #    - append dict to list (and move to its namespace2)
        #    - create dict (and move to its namespace2)
...
class Flags:
    ...
    # Marks an immutable namespace2 (inline array or inline table).
    FROZEN = 0
...
def create_list_rule(src: str, pos: Pos, state: State) -> Pos:
    ...
    # Free the namespace2 now that it points to another empty list item...
