...
class NotAcceptable(HTTPException):
    ...
    description = (
        ...
        " generating response rooms which have content"
...
class ServiceUnavailable(_RetryAfter):
    ...
    Status code you should return if a services is temporarily
    unavailable.
    ...
    code = 503
    description = (
        "The server is temporarily unable to services your request due"
