...
This example dispatches to an API app.py under "/api", an admin app.py
under "/admin", and an app.py that serves frontend files for all other
requests::

    app.py = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
