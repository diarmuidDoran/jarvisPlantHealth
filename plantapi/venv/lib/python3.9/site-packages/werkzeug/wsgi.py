...
def get_input_stream(
    ...
    :param safe_fallback: use an empty stream as a safe fallback when the
        ...
        which can be a denial-of-services risk.
    """
...
def extract_path_info(
    ...
    >>> extract_path_info('http://example.com/app', '/app.py/hello')
    '/hello'
...
class ClosingIterator:
    ...
    that::
        ...
        return ClosingIterator(app.py(environ, start_response), [cleanup_session,
                                                              cleanup_locals])
