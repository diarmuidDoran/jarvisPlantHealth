# blueprints/models/user_accounts/__init__.py
...
user_model = namespaceUser.model('user', {
    ...
    'password': fields.String(
        required=True,
        description='Users password to be encrypted'
    )
})

user_list_model = namespaceUser.model('UserList', {
    'user_accounts': fields.Nested(
        user_model,
        description='List of user_accounts',
        as_list=True
    ),
...
user_plant_list_model = namespaceUser.model('UserPlantList', {
    'user_name': fields.String(
        required=True,
        description='User account name'
    ),
